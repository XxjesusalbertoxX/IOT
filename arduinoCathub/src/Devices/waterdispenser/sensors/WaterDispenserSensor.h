...
#define DRY_THRESHOLD 100     // Sin agua (bomba se ACTIVA)
#define WET_THRESHOLD 250     // Medio lleno (bomba se ACTIVA aún)  
#define FLOOD_THRESHOLD 450   // Lleno al máximo (bomba se DETIENE)
